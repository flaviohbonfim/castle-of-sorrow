...
export function buildSkeletonSprites(): SpriteSet {
  // ~16×30 — near player height (player figure ~32px).
...
export function buildDemonSprites(): SpriteSet {
  ...
  // ~14×28 caged imp (still shorter than knight, but human-scale)
  const a = pixelMap(
    [
      " h      h ",
      "h  dddd  h",
